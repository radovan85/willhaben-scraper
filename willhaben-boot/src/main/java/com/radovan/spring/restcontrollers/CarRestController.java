...
public class CarRestController {
	...
	/*
	@GetMapping(value = "/carDetails/{carId}")
	public ResponseEntity<CarDto> getCarDetails(@PathVariable("carId") Long carId) throws IOException {
		CarDto car = carService.getCarById(carId);
		return new ResponseEntity<>(scrapingService.scrapeCarDetails(car.getSeoUrl()), HttpStatus.OK);
	}
	*/
}
