...
public class ScrapingServiceImpl implements ScrapingService {
	...
	@Override
	public List<CarDto> scrapeCars() throws IOException {
	...
	/*
	public CarDto scrapeCarDetails(String url) {
		System.out.println("Scraping details");
		...
		try {
			...
			if (pageProps.has("advertDetails")) {
			    JsonObject advertDetails = pageProps.getAsJsonObject("advertDetails");
			    if (advertDetails.has("attributes")) {
			        JsonArray attributesArray = advertDetails.getAsJsonArray("attributes");
			        ...
			        for (JsonElement attribute : attributesArray) {
			            ...
			            String attributeValue = attributeObject.get("value").getAsString();
			            System.out.println(attributeName + ": " + attributeValue);
			        }
			    } else {
			        System.out.println("No attributes found in advertDetails.");
			    }
			} else {
			    System.out.println("Advert Details not found in props.");
			}
